...
| 스킬 | 커맨드 | 설명 |
|------|--------|------|
| go-coder | `/golang:go-coder` | 타입, 인터페이스, 에러 처리, 동시성, 서비스 설계, 복원력 |
| go-reviewer | `/golang:go-reviewer` | 에러 처리, 동시성 안전, 네이밍, API 설계, 성능, 보안 |
| go-tester | `/golang:go-tester` | table-driven 테스트, 벤치마크, fuzzing, mock, 통합 테스트, 커버리지 |
